...
<head>
  ...
  <title>Ganesh Software Company names</title>
  <style>
    body {
      margin: 0;
...
<div class="services client-section">
  <div class="card client-card">
    ...
    <h3 class="client-name">Manesha galam khammam wipro 3+ she practicing today class </h3>
...
<style>
  ...
  <div class="contact">
    ...
    <p><strong>Phone:</strong> +91-7013745096</p>
